...
def run_adv_attacks(args):
    ...
    print(l0_norms_perts_max_l_inf)
    print("adv_compute_time")
    print(adv_compute_time)
    print("adv_compute_time_std")
    print(adv_compute_time_std)
    ...
    if args.save_results:
        ...
        for l0_norm_idx, l0_norm in enumerate(att_l0_norms):
            ...
            save_path = args.adv_pert_save_path + '/adv_input_l0_norm_' + norm_str + '.pt'
        ...
        for l0_norm_idx, l0_norm in enumerate(att_l0_norms):
            ...
            print(save_path)
            save_img_tensors(save_path, l0_norms_adv_x[l0_norm_idx], args.y_test, None, args.labels_str_dict)
